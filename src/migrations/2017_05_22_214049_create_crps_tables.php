...
class CreateSubjectsTable extends Migration
{
    ...
    public function up()
    {
		...
		if ( !(Schema::hasTable('aspects')) ) {
    		Schema::create('aspects', function(Blueprint $t){
				$t->increments('id');
		...
		if ( !(Schema::hasTable('aspect_subject')) ) {
    		Schema::create('aspect_subject', function(Blueprint $t){
				$t->increments('id');
				$t->integer('aspect_id');
		...
		if ( !(Schema::hasTable('aspect_types')) ) {
    		Schema::create('aspect_types', function(Blueprint $t){
				$t->increments('id');
		...
		if ( !(Schema::hasTable('subject_types')) ) {
    		Schema::create('subject_types', function(Blueprint $t){
				$t->increments('id');
				$t->string('type_name');
